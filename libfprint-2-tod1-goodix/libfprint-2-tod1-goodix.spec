...
%install
cd libfprint-2-tod1-goodix
install -Dm 755 usr/lib/x86_64-linux-gnu/libfprint-2/tod-1/libfprint-tod-goodix-53xc-%{version}.so %{buildroot}/usr/lib64/libfprint-2/tod-1/libfprint-tod-goodix-53xc-%{version}.so
